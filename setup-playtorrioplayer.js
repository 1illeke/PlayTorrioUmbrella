...
const DOWNLOAD_URLS = {
    win32: 'https://github.com/ayman708-UX/PlayTorrioPlayerV2/releases/download/v1.8.45/PlayTorrio-Windows-x64.zip',
    darwin: 'https://github.com/ayman708-UX/PlayTorrioPlayerV2/releases/download/v1.8.45/PlayTorrio-macOS-Universal.zip',
    linux: 'https://github.com/ayman708-UX/PlayTorrioPlayerV2/releases/download/v1.8.45/NipaPlay-1.8.45-Linux-amd64.AppImage'
};
...
function verifyInstallation() {
    ...
    if (process.platform === 'win32') {
        ...
        // Check for specific AppImage names from v1.8.45+ release (NipaPlay) and older versions
